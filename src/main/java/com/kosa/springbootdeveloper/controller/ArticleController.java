...
public class ArticleController {
    ...
    public ResponseEntity<Article> addArticle(@RequestBody ArticleAddRequestDto dto, Principal principal) {
        Article savedArticle = articleService.save(dto, principal.getName());
