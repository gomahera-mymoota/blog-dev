package com.kosa.springbootdeveloper.config.oauth;
...
import com.kosa.springbootdeveloper.util.CookieUtil;
...
public class OAuth2SuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    private String getTargetUrl(String token) {
        String result = UriComponentsBuilder.fromUriString(REDIRECT_PATH)
